...
% clearvars -except A_cell V_cell
clear
block_size = [32 32];
...
%     return
    ...
    %     fprintf('Calculando GFT dos blocos.\n');
        ...
        ssim_dct(r) = ssim(r_atual,cell2mat(r_dct_quant));
        ...
        ssim_gft(r) = ssim(r_atual,cell2mat(r_gft_quant));


        if ssim_gft(r)<ssim_dct(r)

            while ssim_gft(r)<ssim_dct(r)
